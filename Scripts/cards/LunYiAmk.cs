...
public class LunYiAmk: CustomCardModel
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new BlockVar(3m, ValueProp.Unpowered | ValueProp.Move)];
	...
	public LunYiAmk() : base(-1, CardType.Skill, CardRarity.Common, TargetType.None ,true){}
