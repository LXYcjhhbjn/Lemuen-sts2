...
public class QiangXieEmk: CustomCardModel
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<ZhuanZhu>(2m),new PowerVar<AIM>(2m)];
    ...
    public QiangXieEmk() : base(-1, CardType.Skill, CardRarity.Uncommon, TargetType.None ,true){}
