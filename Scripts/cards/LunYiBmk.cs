...
public class LunYiBmk: CustomCardModel
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new BlockVar(5m, ValueProp.Unpowered | ValueProp.Move)];
	...
	public LunYiBmk() : base(-1, CardType.Skill, CardRarity.Uncommon, TargetType.None ,true){}
